...
try {
  ...
  $mail->Username   = 'roastercompany@yandex.ru'; // Логин на почте
  $mail->Password   = 'qyuokcaiutriqdue'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('roastercompany@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('roastercompany@yandex.ru');
